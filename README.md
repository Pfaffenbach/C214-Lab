...
> Repositório para armazenar os códigos e as atividades feitas durante o laboratório de C214 (Engenharia de Software) ministradas pelo professor.

### Atividades feitas/entregues

Aulas ainda estão em andamento, segue atividades que já foram feitas/entregues ao professor:

- [x] Revisão sobre POO;
- [x] Gerencia de Dependencias;
- [x] Git/GitHub;
- [x] Readme;
